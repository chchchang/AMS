<?php
	...
	define('HOME','/home/ams/IabFiles/hours/');
	...
	if(isset($_GET["DATE"]))
		...
		$searchDate = date("Y-m-d H",strtotime("-1 hours"));
	//$searchDate = date("Y-m-d");
	$st = $searchDate.":00:00";
	$et = $searchDate.":59:59";
	$hourFileName  = str_replace(" ","_",$searchDate);
	...
	function produceIabFile($orbitData){
		global $hourFileName;
		$my=new MyDB(true);
		$filename = HOME.$hourFileName."_orbitLogs.txt";
