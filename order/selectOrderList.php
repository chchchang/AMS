...
<script type="text/javascript">
	...
	function showOrderList(option){
		...
		if(typeof(option.search)!='undefined'&&option.search==true)
			bypost={method:'OrderListInfo',searchBy:$('#shearchText').val(),pageNo:1,order:'委刊單識別碼',asc:'ASC'};
		else if(typeof(option.ownerId)!='undefined')
			bypost={method:'OrderListInfo',pageNo:1,order:'委刊單識別碼',asc:'ASC',searchBy:$('#shearchText').val(),廣告主識別碼:option.ownerId};
